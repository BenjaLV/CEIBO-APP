...
const Partners = () => {
  ...
  useEffect(() => {
    axios
      .get(`${URL_BACK}/users/admin/socio`, useCredentials)
      .then((response) => {
    ...
    axios
      .get(`${URL_BACK}/customers/all`, useCredentials)
      .then((response) => {
  ...
  const handleUpdatePartner = (partnerId, updatedPartner) => {
    axios
      .put(
        `${URL_BACK}/users/admin/members/${partnerId}`,
        updatedPartner,
        {
                  ...
                  <tbody>
                    {filteredPartners.length > 0 ? (
                      filteredPartners.map((partner) => (
                        <tr className="prueba" key={partner._id}>
